...
import { color, width } from '../../utils/style';
import { H4, Tip } from '../../components/text';

class MyMusic extends PureComponent {
  static navigationOptions = ({ navigation }) => ({
    tabBarLabel: '朋友',
    tabBarIcon: ({ tintColor }) => <Icon name="ios-people-outline" size={32} color={tintColor} />,
    headerTitle: (
      <View
        style={{
          width,
      ...
      >
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Player', { title: '播放器' })}>
          <Icon name="ios-stats-outline" size={30} color="#ffffff" />
        </TouchableOpacity>
      </View>
    ),
    headerStyle: {
